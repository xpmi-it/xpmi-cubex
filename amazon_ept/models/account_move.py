...
class AccountMove(models.Model):
    ...
    so_reimburse_invoice_id = fields.Many2one('sale.order', string='SaleOrder Reimbursed')
    ...
    def upload_odoo_invoice_to_amazon(self, args={}):
        ...
        for instance in seller.instance_ids:
            query = sql.SQL("""select id from account_move WHERE amazon_instance_id = %s and state = 'posted' and 
                        invoice_sent = False {}""").format(sql.SQL(refund_inv))
