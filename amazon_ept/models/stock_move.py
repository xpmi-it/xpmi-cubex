...
class StockMove(models.Model):
    ...
    is_unidentified_counterpart = fields.Boolean("Unidentified counterpart?", default=False,
                                                 help="If ticked then we mark move is unidentified counterpart.")
        ...
        if proc_group and proc_group.odoo_shipment_id:
            res.update({
                ...
                'seller_id': proc_group.odoo_shipment_id and
                             ...
                             False, })
        elif proc_group and proc_group.new_odoo_shipment_id:
            res.update({
                'partner_id': proc_group.new_odoo_shipment_id.ship_from_address_id and
                              proc_group.new_odoo_shipment_id.ship_from_address_id.id,
                'new_ship_plan_id': proc_group.new_odoo_shipment_id.shipment_plan_id and
                                    proc_group.new_odoo_shipment_id.shipment_plan_id.id,
                'amazon_shipment_id': proc_group.new_odoo_shipment_id.shipment_confirmation_id,
                # 'ship_label_preference': proc_group.new_odoo_shipment_id.label_prep_type,
                'fulfill_center': proc_group.new_odoo_shipment_id.fulfill_center_id,
                'new_odoo_shipment_id': proc_group.new_odoo_shipment_id.id,
                'seller_id': proc_group.new_odoo_shipment_id and
                             proc_group.new_odoo_shipment_id.shipment_plan_id and
                             proc_group.new_odoo_shipment_id.shipment_plan_id.instance_id.seller_id and
                             proc_group.new_odoo_shipment_id.shipment_plan_id.instance_id.seller_id.id or
                             False, })
        elif proc_group and proc_group.new_odoo_awd_shipment_id:
            res.update({
                'partner_id': proc_group.new_odoo_awd_shipment_id.ship_from_address_id and
                              proc_group.new_odoo_awd_shipment_id.ship_from_address_id.id,
                # 'new_ship_plan_id': proc_group.new_odoo_shipment_id.shipment_plan_id and
                #                     proc_group.new_odoo_shipment_id.shipment_plan_id.id,
                'amazon_shipment_id': proc_group.new_odoo_awd_shipment_id.shipment_id,
                # 'ship_label_preference': proc_group.new_odoo_shipment_id.label_prep_type,
                # 'fulfill_center': proc_group.new_odoo_shipment_id.fulfill_center_id,
                'new_odoo_awd_shipment_id': proc_group.new_odoo_awd_shipment_id.id,
                'seller_id': proc_group.new_odoo_awd_shipment_id and
                             proc_group.new_odoo_awd_shipment_id.instance_id_ept.seller_id.id or False, })
        return res
