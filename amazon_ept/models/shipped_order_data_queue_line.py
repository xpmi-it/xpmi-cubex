...
class ShippedOrderDataQueueLine(models.Model):
    ...
    order_status = fields.Selection([('Pending', 'Pending'), ('Unshipped', 'Unshipped'),
                                     ('PartiallyShipped', 'PartiallyShipped'), ('Shipped', 'Shipped'),
                                     ('Canceled', 'Canceled'), ('Unfulfillable', 'Unfulfillable'),
                                     ('InvoiceUnconfirmed', 'InvoiceUnconfirmed'),
                                     ('PendingAvailability', 'PendingAvailability')], string="Order Status")
