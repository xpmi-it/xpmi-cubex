...
class ShipmentReportConfigureFulfillmentCenterEPT(models.TransientModel):
    ...
    def default_get(self, field):
        """
        Inherited this method for update missing fulfillment centers in the wizard form
        view to configure as per available countries.
        :param: field: list []
        :return: dict {}
        """
    ...
    def configure_shipment_fulfillment_center(self):
        """
        Define this method for save Fulfillment Center in seller's warehouse on basis of
        country selected from wizard.
        :return: True
        """
